...
// to Social Lab's access control layer. No runtime implementation exists yet;
...
//   - Making OCapN a hard dependency (Social Lab must work without it)
// =============================================================================

import { StubProtocolAdapter } from '../protocol-adapter.js';

// ---------------------------------------------------------------------------
// Capability Model: Social Lab Resource-to-Capability Mapping
// ---------------------------------------------------------------------------
// This constant documents how Social Lab resources map to OCapN capabilities.
...
// Example:    ocapn://social-lab-node-abc123/sn-7f8a9b2c
//
...
// ---------------------------------------------------------------------------
// Social Lab components modeled as Goblins actors for eventual distributed
...
export class OcapnAdapter extends StubProtocolAdapter {
  constructor() {
    super({
      ...
      description:
        ...
        'the capability model design and how it maps to Social Lab access control ' +
      ...
      stubNote:
        ...
        'the capability model for Social Lab. No runtime operations are available. ' +
    ...
    return {
      ...
      details: {
        ...
        implementationPhases: {
          ...
          'phase-3': 'Full Goblins actor model for Social Lab components',
        },
  ...
  /**
   * Returns the full capability model mapping Social Lab resources to OCapN caps.
   * @returns {Object}
   */
  getCapabilityModel() {
  ...
  /**
   * Returns the Sturdyref URI specification for Social Lab.
   * @returns {Object}
   */
  getSturdyrefSpec() {
