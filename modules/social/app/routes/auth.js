...
<head>
  ...
  <title>Log In - PeerMesh Social</title>
...
<body>
  <div class="auth-container">
    <div class="auth-logo">PeerMesh Social</div>
...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>Sign Up - PeerMesh Social</title>
  <meta name="robots" content="noindex, nofollow">
  <link rel="stylesheet" href="/static/tokens.css">
  <style>${AUTH_CSS}</style>
</head>
...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>SSO Authorization - PeerMesh Social</title>
  <meta name="robots" content="noindex, nofollow">
  <link rel="stylesheet" href="/static/tokens.css">
  <style>${AUTH_CSS}
    .sso-info {
