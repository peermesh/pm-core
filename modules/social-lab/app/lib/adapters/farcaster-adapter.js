...
//      Authorizes Social Lab to submit casts on behalf of the user.
...
//   - User opts in via Social Lab settings ("Connect to Farcaster").
...
//
// Cross-posting:
//   - Social Lab posts optionally cross-posted as Farcaster casts.
//   - 320 character limit; long posts truncated with link back to Social Lab.
...
//   - Farcaster follows are NOT automatically bridged to Social Lab.
  ...
  async provisionIdentity(profile) {
    return {
      ...
      metadata: {
        ...
        crossPosting: {
          charLimit: 320,
          longPostHandling: 'Truncated with link back to full Social Lab post',
