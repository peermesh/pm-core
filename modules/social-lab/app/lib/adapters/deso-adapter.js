...
//      that handles key management and transaction signing. Social Lab integrates
//      as a third-party app requesting identity verification.
//      NO private key custody by Social Lab.
...
//      Social Lab does NOT subsidize fees; user must have sufficient balance.
//
...
//   - NO trading, diamond sending, or NFT minting in Social Lab.
//
// Deployment modes:
  ...
  constructor() {
    super({
      ...
      requires: [
        ...
        'DESO token balance (user-funded, Social Lab does NOT subsidize fees)',
    ...
    return {
      ...
      metadata: {
        ...
        identityModel: {
          ...
          noCustody: 'Social Lab NEVER holds DeSo private keys',
        ...
        crossPosting: {
          ...
          fees: 'User pays DESO transaction fees — Social Lab does NOT subsidize',
          transactionTypes: {
