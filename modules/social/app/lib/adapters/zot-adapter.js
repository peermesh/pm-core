...
//   Mode 4 (BYOP): Proxy channel on Social, linked to external WebID.
    ...
    try {
      ...
      return {
        ...
        details: {
          ...
          nomadicIdentityNote: 'Zot nomadic identity pattern (multi-server clone sync with seamless migration) is architecturally significant and informs Social portability design.',
        },
      };
    } catch (err) {
      return {
