...
// Bonfire is a modular ActivityPub toolkit (Elixir/Phoenix). Social Lab
...
//
// Note: Bonfire runs Elixir/Phoenix — Social Lab does NOT embed Bonfire.
  ...
  async healthCheck() {
    return {
      ...
      details: {
        ...
        stfAlignment: 'Documented in blueprint. Social Lab aligns with Sovereign Tech Fund goals.',
      },
    };
  }
}
