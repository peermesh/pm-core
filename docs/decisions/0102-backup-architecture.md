...
The peermesh-core project manages stateful services including databases (PostgreSQL, MySQL, MongoDB) and object storage (MinIO). While individual profile backup scripts exist, the current approach has significant gaps:
