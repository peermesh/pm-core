...
1. **Docker Lab itself** is a "module" within the parent knowledge-graph-lab-alpha ecosystem
...
The parent project (knowledge-graph-lab-alpha) uses "module" to mean **application services** -- full-stack components like backend APIs, frontend UIs, AI services, and publishing pipelines. These live at `knowledge-graph-lab-alpha/modules/standalone/` and are governed by compliance specifications ("Standalone Module Requirements" and "PeerMesh Module Requirements").
