...
//   - Community Solid Server (CSS) running as a Docker service in Docker Lab
...
//
// Docker Lab integration steps (for the Docker Lab team):
...
export async function provisionPod(profileId, options = {}) {
  ...
  return {
    ...
    reason: 'CSS not deployed. Community Solid Server must be added to Docker Lab as a Docker service before Pod provisioning is available.',
    requirements: [
