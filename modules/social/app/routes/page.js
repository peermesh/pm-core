...
<head>
  ...
  <title>${displayName} - PeerMesh Social</title>
  <meta name="description" content="${bio || displayName + ' on PeerMesh Social'}">
...
<body>
  <main class="profile-page${bannerUrl ? ' has-banner' : ''}">
    ...
    <div class="federation-footer">
      ...
      <p class="powered-by">Powered by PeerMesh Social</p>
    </div>
  </main>
</body>
</html>`;
