...
/** PeerMesh Social namespace */
const PMSL = 'https://vocab.peermesh.org/social#';
...
/**
 * Containers that must exist in every Social Pod.
 ...
 * Creates all required LDP containers for a Social Pod.
 *
 * @param {string} podUrl - Pod root URL
