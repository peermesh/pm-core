...
**Model Selection:**
- Default: **Opus**. Sonnet only for leaf-node execution of well-defined work orders.
- Canonical rubric: `~/.agents-gas-prompt-library/workflows/opus_vs_sonnet_decision_guide_token_efficient.md`
- Sonnet never steers, plans, orchestrates, or creates artifacts others depend on.
